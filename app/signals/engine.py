...
Outputs are ALWAYS heuristic estimates with plain-language explanations; the
national tariff-line pipelines (Phase 3) will override these with measured
splits where available (basis="national_tariff_line", confidence="high").
"""
